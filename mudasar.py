...
\033[1;96m ┈┈┈┈▕╲▂▂╱▏┈┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈┈▕╲▂▂╱▏┈┈┈┈
\033[1;96m ╱▔▔▔▔┊┊┊┊▔▔▔▔╲☞☞☞☞☞☞\033[1;91m☜☜☜☜☜╱▔▔▔▔┊┊┊┊▔▔▔▔╲
\033[1;96m................\033[1;93mMuhammad_Mudasar\033[1;91m...............
\033[1;96m................\033[1;93m✬🄵🄰🄲🄴🄱🄾🄾🄺✬\033[1;91m..............

\033[1;96m░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░

\033[1;91m☞ Auther     : Muhammad_Mudasar_Boss_Trick
\033[1;92m☞ WhatsApp   : 03174050946
\033[1;95m☞ YouTube    : https://youtube.com/channel/UCLX2txazXiOQXADbYXx4bEw
...
def login():
	...
	try:
		...
		if 'access_token' in z:
		    ...
		    os.system('xdg-open https://youtube.com/channel/UCLX2txazXiOQXADbYXx4bEw')
		    menu()
		else:
...
def menu():
	...
	print (S + '[' + P + '☞2' + S + ']' + S + ' Update Mudasar_JuttTool')
...
def mb():
	...
	if bm =='':
	    ...
	    os.system('rm -rf $HOME/B4_Mudasar')
	    os.system('cd $HOME && git clone https://github.com/Muhammad_Mudasar/Jutt')
	    cb()
	    print (logo)
	    psb('☆10%')
	    psb('☆☆20%')
	    ...
	    psb('WhatsApp Num 03174050946✓')
	    psb('WellCome To B4_BALOCH')
	    psb('Congratulations B4_Mudasar Tool Has Been Updated Successfully')
	    psb('🔓User Name☆ Mudasar✓')
	    psb('🔓Password ☆ Jutt✓')
	    psb('Subscrib My Youtube Channel Mudasar Yahya✓')
	    psb('Please Login Again')
	    time.sleep(2)
	    os.system('cd $Jutt_mudasar && python2 jutt.py')
	elif bm =='3':
